...
time. Every hotel table also shows a green-tinted **✅ Done** column with the most recent data date a
hotel was actioned, so at a glance you can see what's already handled and avoid duplicating it. When
