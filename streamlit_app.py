...
tabs = st.tabs(["⚡ Decision Matrix", "🎯 Margin Moves", "Overview", "Hotel Actions",
                ...
                "↗ Price & Clicks Trends", "📂 Files", "📖 Guide"])
...
with tabs[4]:
    ...
    if hotels.empty:
        ...
        _sty = apply_colors(_sty, {"WR Now": c_winrate, "WR Est": c_winrate,
                                   ...
                                   "Action": c_action, "Offer": c_offer}, show.columns)
        st.dataframe(_sty, use_container_width=True, height=520)
    ...
    if hotels.empty:
        ...
        if pg.empty:
            ...
            _sty = apply_colors(_sty, {"Avg Gap %": c_gap, "% Below Floor": _const(CLR_RED),
                                       "Verdict": _const(CLR_RED), "Offer": c_offer}, show.columns)
...
with tabs[8]:
    ...
    _sty = apply_colors(_sty, {"Margin": _const(CLR_ORANGE), "Offer": c_offer}, show.columns)
